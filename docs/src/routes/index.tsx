        ...
        <section className="relative w-full overflow-hidden min-h-[500px]">
          ...
          <div className="relative z-10 max-w-[1400px] mx-auto px-6 sm:px-10">
            <div className="pt-20 pb-32 max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row gap-3" style={{ fontFamily: '"WhyteVariable", Inter, -apple-system, "system-ui", "Segoe UI", Roboto, sans-serif', fontWeight: 300, fontVariationSettings: '"wght" 300, "MONO" 1, "INKT" 1' }}>
                <Link
                  to="/docs/$"
                  params={{ _splat: '' }}
      ...
      <div className="bg-[#E2E2E2] text-[#242424]">
        ...
        <div className="max-w-[1400px] mx-auto space-y-16 pb-16 px-6 sm:px-10">
          ...
          */}
          ...
          <SectionRule name="About StepKit" className="pt-20" border={false} />

          {/* About StepKit */}
          <section className="bg-[#E2E2E2] text-[#242424] pt-8 -mx-6 sm:-mx-10 px-6 sm:px-10">

            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-start">
              <div className="space-y-6 border-t-[0.25px] border-t-[#242424]">
                <p className="leading-relaxed pt-6 md:pt-2">
                ...
                <p className="leading-relaxed">
                  ...
                  evolves. <span className="font-semibold underline">StepKit was built for iteration.</span>
                </p>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-8 mt-8 border-t-[0.25px] border-t-[#242424] ">
                  <div className="space-y-6">
                    <p className="uppercase pt-2 text-sm" style={{ fontFamily: '"WhyteVariable", Inter, -apple-system, "system-ui", "Segoe UI", Roboto, sans-serif', fontWeight: 400, fontVariationSettings: '"wght" 400, "MONO" 1, "INKT" 1' }}>This means you&nbsp;can:</p>
                  </div>
                  <div className="space-y-6">
              ...
              <div className="bg-[#1e1e1e] px-1 text-xs text-white overflow-auto border border-gray-800 rounded md:-mt-12">
                <SyntaxHighlighter
                  language="typescript"
                  style={vscDarkPlus}
                  showLineNumbers
    ...
    await step.run("merge-pr", async () => {
      await github.mergePR(input.prNumber);
          ...
          <section className="px-0 py-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 sm:px-10 md:pl-52 md:pr-0 ">
              {[
                {
                  id: '001',
                  title: (
                    <>
                      PLATFORM, LANGUAGE &amp;<br /> ARCHITECTURE AGNOSTIC
                    </>
                  ),
      ...
      <div className="bg-[#242424] text-white">
        <div className="relative max-w-[1400px] mx-auto pt-8 pb-42 px-6 sm:px-10 overflow-hidden">
          <div
            aria-hidden="true"
            className="pointer-events-none absolute inset-0 bg-[url('/img/connect.svg')] bg-no-repeat bg-right bg-contain opacity-80"
          />
          ...
          <div className="relative z-10 space-y-4">
            <p className="mt-8">Run functions on any cloud provider,<br /> using drivers for orchestration.</p>
            <p className="my-4">[<Tick />] Server</p>
            <p className="my-4">[<Tick />] Serverless</p>
            <p className="my-4">[<Tick />] Containers & K8S</p>
          </div>
            ...
            {workflowFeatures.map((feature) => {
              ...
              return (
                <span
                  ...
                  className={`inline-flex items-center rounded-full border border-[#24242480] px-4 py-2 text-sm tracking-wide uppercase transition-colors cursor-pointer font-mono ${isActive
