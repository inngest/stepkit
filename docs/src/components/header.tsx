...
export function Header({ activeItem }: HeaderProps) {
  return (
  <nav className="w-full pt-6 uppercase tracking-normal font-mono">
    <div className="grid grid-cols-6 gap-4 items-stretch">
      <a href="/" className="h-full flex items-center justify-start space-x-2 border-t-4 border-white pt-2 hover:opacity-70">
        <span className="text-2xl font-bold leading-none">StepKit</span>
        <span className="text-[9px]">BY INNGEST</span>
      </a>

      <a href="/docs" className="h-full border-t-4 border-white pt-2 flex items-center justify-end text-right space-x-2 hover:opacity-70">
        <svg className="w-2 h-2 fill-white" viewBox="0 0 10 10"><rect width="10" height="10" /></svg>
        <span>Docs</span>
      </a>

      <a href="/docs/learn/examples/ai-rag-workflow" className="h-full border-t-4 border-white pt-2 flex items-center justify-end text-right space-x-2 hover:opacity-70">
        <svg className="w-2 h-2 fill-white" viewBox="0 0 10 10"><rect width="10" height="10" /></svg>
        <span>Examples</span>
      </a>
      ...
      */}
      ...
      <div className="col-span-3 h-full flex items-start justify-end space-x-3">
        {/*<a href="#" className="px-2 py-1 border border-white text-[9px] md:text-[10px] tracking-normal hover:bg-white hover:text-black">STEP_RUN-LATEST</a>*/}
        <a href="https://www.github.com/inngest/stepkit" className="flex items-center justify-end text-right h-[36px] w-[36px]">
          <GithubIcon />
        </a>
      </div>
    </div>
